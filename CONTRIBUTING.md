...
should match Live Preview, and source mode should show the raw markdown under
the same bands and highlight colors, with the callout character tinted rather
than replaced by a marker. That script needs the Inter font
